TARGETS = ai alert finding iam project report organization_iam organization org_alert
...
proto-validate: fmt
	for svc in "project" "report" "ai" "organization" "organization_iam" "org_alert"; do \
		protoc \
			--proto_path=proto \
			--error_format=gcc \
