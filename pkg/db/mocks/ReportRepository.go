...
// GetReportFindingForOrganization provides a mock function with given fields: _a0, _a1, _a2, _a3, _a4, _a5, _a6
func (_m *ReportRepository) GetReportFindingForOrganization(_a0 context.Context, _a1 uint32, _a2 []uint32, _a3 []string, _a4 string, _a5 string, _a6 float32) (*[]model.ReportFinding, error) {
	...
	var r0 *[]model.ReportFinding
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint32, []uint32, []string, string, string, float32) (*[]model.ReportFinding, error)); ok {
		return rf(_a0, _a1, _a2, _a3, _a4, _a5, _a6)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint32, []uint32, []string, string, string, float32) *[]model.ReportFinding); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, uint32, []uint32, []string, string, string, float32) error); ok {
