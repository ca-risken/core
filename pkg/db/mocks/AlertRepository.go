...
// ListAlertCondNotificationForNotification provides a mock function with given fields: _a0, _a1, _a2
func (_m *AlertRepository) ListAlertCondNotificationForNotification(_a0 context.Context, _a1 uint32, _a2 uint32) (*[]model.AlertCondNotification, error) {
	ret := _m.Called(_a0, _a1, _a2)

	if len(ret) == 0 {
		panic("no return value specified for ListAlertCondNotificationForNotification")
	}

	var r0 *[]model.AlertCondNotification
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint32, uint32) (*[]model.AlertCondNotification, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint32, uint32) *[]model.AlertCondNotification); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*[]model.AlertCondNotification)
...
// ListOrgAlertNotificationTarget provides a mock function with given fields: _a0, _a1, _a2
func (_m *AlertRepository) ListOrgAlertNotificationTarget(_a0 context.Context, _a1 uint32, _a2 uint32) ([]*db.OrgAlertNotificationTarget, error) {
	ret := _m.Called(_a0, _a1, _a2)

	if len(ret) == 0 {
		panic("no return value specified for ListOrgAlertNotificationTarget")
	}

	var r0 []*db.OrgAlertNotificationTarget
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint32, uint32) ([]*db.OrgAlertNotificationTarget, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint32, uint32) []*db.OrgAlertNotificationTarget); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
...
// WithLockedOrgAlertNotificationTarget provides a mock function with given fields: _a0, _a1, _a2, _a3, _a4, _a5
func (_m *AlertRepository) WithLockedOrgAlertNotificationTarget(_a0 context.Context, _a1 uint32, _a2 uint32, _a3 uint32, _a4 uint32, _a5 func(*db.OrgAlertNotificationTarget) (bool, error)) error {
	ret := _m.Called(_a0, _a1, _a2, _a3, _a4, _a5)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, uint32, uint32, uint32, uint32, func(*db.OrgAlertNotificationTarget) (bool, error)) error); ok {
		r0 = rf(_a0, _a1, _a2, _a3, _a4, _a5)
	} else {
		r0 = ret.Error(0)
	}
