...
// GetOrganizationPolicyByUserID provides a mock function with given fields: ctx, userID
func (_m *OrganizationIAMRepository) GetOrganizationPolicyByUserID(ctx context.Context, userID uint32) (*[]model.OrganizationPolicy, error) {
