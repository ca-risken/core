...
// AskAlertAISummaryFromFinding provides a mock function with given fields: ctx, f, r, lang
func (_m *AIService) AskAlertAISummaryFromFinding(ctx context.Context, f *model.Finding, r *model.Recommend, lang string) (string, error) {
	ret := _m.Called(ctx, f, r, lang)

	if len(ret) == 0 {
		panic("no return value specified for AskAlertAISummaryFromFinding")
	}
