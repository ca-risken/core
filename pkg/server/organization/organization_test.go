...
func TestCreateOrganization(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			putPolicyResponse:          &org_iam.PutOrgPolicyResponse{Policy: &org_iam.OrgPolicy{PolicyId: 1, Name: "policy", ActionPtn: ".*", ProjectPtn: ".*", OrganizationId: 1, CreatedAt: now.Unix(), UpdatedAt: now.Unix()}},
			...
			attachPolicyResponse:       &org_iam.AttachOrgPolicyResponse{Policy: &org_iam.OrgPolicy{PolicyId: 1, Name: "policy", ActionPtn: ".*", ProjectPtn: ".*", OrganizationId: 1, CreatedAt: now.Unix(), UpdatedAt: now.Unix()}},
