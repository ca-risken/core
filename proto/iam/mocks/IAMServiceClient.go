...
// GetUserByUserIdpKey provides a mock function with given fields: ctx, in, opts
func (_m *IAMServiceClient) GetUserByUserIdpKey(ctx context.Context, in *iam.GetUserByUserIdpKeyRequest, opts ...grpc.CallOption) (*iam.GetUserByUserIdpKeyResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *iam.GetUserByUserIdpKeyRequest, ...grpc.CallOption) (*iam.GetUserByUserIdpKeyResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *iam.GetUserByUserIdpKeyRequest, ...grpc.CallOption) *iam.GetUserByUserIdpKeyResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *iam.GetUserByUserIdpKeyRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
