...
// NewIAMServiceClient creates a new instance of IAMServiceClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewIAMServiceClient(t testing.TB) *IAMServiceClient {
