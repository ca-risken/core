...
// NewIAMServiceServer creates a new instance of IAMServiceServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewIAMServiceServer(t testing.TB) *IAMServiceServer {
