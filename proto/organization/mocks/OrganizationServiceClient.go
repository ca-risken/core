...
// PutOrganizationProject provides a mock function with given fields: ctx, in, opts
func (_m *OrganizationServiceClient) PutOrganizationProject(ctx context.Context, in *organization.PutOrganizationProjectRequest, opts ...grpc.CallOption) (*organization.PutOrganizationProjectResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *organization.PutOrganizationProjectRequest, ...grpc.CallOption) (*organization.PutOrganizationProjectResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *organization.PutOrganizationProjectRequest, ...grpc.CallOption) *organization.PutOrganizationProjectResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *organization.PutOrganizationProjectRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
