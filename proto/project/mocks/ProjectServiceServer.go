...
// NewProjectServiceServer creates a new instance of ProjectServiceServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewProjectServiceServer(t testing.TB) *ProjectServiceServer {
