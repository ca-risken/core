...
// NewReportServiceServer creates a new instance of ReportServiceServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewReportServiceServer(t testing.TB) *ReportServiceServer {
