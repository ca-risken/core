...
type mockConstructorTestingTNewReportServiceServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewReportServiceServer(t mockConstructorTestingTNewReportServiceServer) *ReportServiceServer {
