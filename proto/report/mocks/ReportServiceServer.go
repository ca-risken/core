...
// GetReportFindingForOrganization provides a mock function with given fields: _a0, _a1
func (_m *ReportServiceServer) GetReportFindingForOrganization(_a0 context.Context, _a1 *report.GetReportFindingForOrganizationRequest) (*report.GetReportFindingForOrganizationResponse, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *report.GetReportFindingForOrganizationRequest) (*report.GetReportFindingForOrganizationResponse, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *report.GetReportFindingForOrganizationRequest) *report.GetReportFindingForOrganizationResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *report.GetReportFindingForOrganizationRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
