...
// NewReportServiceClient creates a new instance of ReportServiceClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewReportServiceClient(t testing.TB) *ReportServiceClient {
