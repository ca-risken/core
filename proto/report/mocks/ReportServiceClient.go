...
// GetReportFindingForOrganization provides a mock function with given fields: ctx, in, opts
func (_m *ReportServiceClient) GetReportFindingForOrganization(ctx context.Context, in *report.GetReportFindingForOrganizationRequest, opts ...grpc.CallOption) (*report.GetReportFindingForOrganizationResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetReportFindingForOrganization")
	}

	var r0 *report.GetReportFindingForOrganizationResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *report.GetReportFindingForOrganizationRequest, ...grpc.CallOption) (*report.GetReportFindingForOrganizationResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *report.GetReportFindingForOrganizationRequest, ...grpc.CallOption) *report.GetReportFindingForOrganizationResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*report.GetReportFindingForOrganizationResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *report.GetReportFindingForOrganizationRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
