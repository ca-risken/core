...
// ValidateAll checks the field values on ReportFinding with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in ReportFindingMultiError, or
// nil if none found.
func (m *ReportFinding) ValidateAll() error {
	return m.validate(true)
}

func (m *ReportFinding) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ReportFindingMultiError(errors)
	}

	return nil
}

// ReportFindingMultiError is an error wrapping multiple validation errors
// returned by ReportFinding.ValidateAll() if the designated constraints
// aren't met.
...
func (m ReportFindingMultiError) AllErrors() []error { return m }
