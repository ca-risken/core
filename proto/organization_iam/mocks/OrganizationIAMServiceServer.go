...
// GetSystemAdminOrganizationPolicy provides a mock function with given fields: _a0, _a1
func (_m *OrganizationIAMServiceServer) GetSystemAdminOrganizationPolicy(_a0 context.Context, _a1 *organization_iam.GetSystemAdminOrganizationPolicyRequest) (*organization_iam.GetSystemAdminOrganizationPolicyResponse, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *organization_iam.GetSystemAdminOrganizationPolicyRequest) (*organization_iam.GetSystemAdminOrganizationPolicyResponse, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *organization_iam.GetSystemAdminOrganizationPolicyRequest) *organization_iam.GetSystemAdminOrganizationPolicyResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *organization_iam.GetSystemAdminOrganizationPolicyRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
