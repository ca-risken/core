...
func (_m *OrganizationIAMServiceClient) IsAuthorizedOrgToken(ctx context.Context, in *organization_iam.IsAuthorizedOrgTokenRequest, opts ...grpc.CallOption) (*organization_iam.IsAuthorizedOrgTokenResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *organization_iam.IsAuthorizedOrgTokenRequest, ...grpc.CallOption) (*organization_iam.IsAuthorizedOrgTokenResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *organization_iam.IsAuthorizedOrgTokenRequest, ...grpc.CallOption) *organization_iam.IsAuthorizedOrgTokenResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *organization_iam.IsAuthorizedOrgTokenRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
