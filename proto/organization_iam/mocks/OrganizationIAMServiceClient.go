...
// AnalyzeOrganizationTokenExpiration provides a mock function with given fields: ctx, in, opts
func (_m *OrganizationIAMServiceClient) AnalyzeOrganizationTokenExpiration(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
