...
var file_finding_service_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x2e, 0x66, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x2e, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4c,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4b, 0x0a, 0x0d, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x46, 0x69,
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4d, 0x0a, 0x0e, 0x44, 0x65, 0x6c,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_finding_service_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_finding_service_proto_goTypes = []interface{}{
	...
	(FindingStatus)(0),                  // 43: core.finding.FindingStatus
	(*Finding)(nil),                     // 44: core.finding.Finding
	(*FindingForUpsert)(nil),            // 45: core.finding.FindingForUpsert
	(*FindingTag)(nil),                  // 46: core.finding.FindingTag
	(*FindingTagForUpsert)(nil),         // 47: core.finding.FindingTagForUpsert
	(*Resource)(nil),                    // 48: core.finding.Resource
	(*ResourceForUpsert)(nil),           // 49: core.finding.ResourceForUpsert
	(*ResourceTag)(nil),                 // 50: core.finding.ResourceTag
	(*ResourceTagForUpsert)(nil),        // 51: core.finding.ResourceTagForUpsert
	(*PendFinding)(nil),                 // 52: core.finding.PendFinding
	(*PendFindingForUpsert)(nil),        // 53: core.finding.PendFindingForUpsert
	(FindingSettingStatus)(0),           // 54: core.finding.FindingSettingStatus
	(*FindingSetting)(nil),              // 55: core.finding.FindingSetting
	(*FindingSettingForUpsert)(nil),     // 56: core.finding.FindingSettingForUpsert
	(*emptypb.Empty)(nil),               // 57: google.protobuf.Empty
}
var file_finding_service_proto_depIdxs = []int32{
	43, // 0: core.finding.ListFindingRequest.status:type_name -> core.finding.FindingStatus
	43, // 1: core.finding.BatchListFindingRequest.status:type_name -> core.finding.FindingStatus
	44, // 2: core.finding.GetFindingResponse.finding:type_name -> core.finding.Finding
	45, // 3: core.finding.PutFindingRequest.finding:type_name -> core.finding.FindingForUpsert
	44, // 4: core.finding.PutFindingResponse.finding:type_name -> core.finding.Finding
	46, // 5: core.finding.ListFindingTagResponse.tag:type_name -> core.finding.FindingTag
	47, // 6: core.finding.TagFindingRequest.tag:type_name -> core.finding.FindingTagForUpsert
	46, // 7: core.finding.TagFindingResponse.tag:type_name -> core.finding.FindingTag
	48, // 8: core.finding.GetResourceResponse.resource:type_name -> core.finding.Resource
	49, // 9: core.finding.PutResourceRequest.resource:type_name -> core.finding.ResourceForUpsert
	48, // 10: core.finding.PutResourceResponse.resource:type_name -> core.finding.Resource
	50, // 11: core.finding.ListResourceTagResponse.tag:type_name -> core.finding.ResourceTag
	51, // 12: core.finding.TagResourceRequest.tag:type_name -> core.finding.ResourceTagForUpsert
	50, // 13: core.finding.TagResourceResponse.tag:type_name -> core.finding.ResourceTag
	52, // 14: core.finding.GetPendFindingResponse.pend_finding:type_name -> core.finding.PendFinding
	53, // 15: core.finding.PutPendFindingRequest.pend_finding:type_name -> core.finding.PendFindingForUpsert
	52, // 16: core.finding.PutPendFindingResponse.pend_finding:type_name -> core.finding.PendFinding
	54, // 17: core.finding.ListFindingSettingRequest.status:type_name -> core.finding.FindingSettingStatus
	55, // 18: core.finding.ListFindingSettingResponse.finding_setting:type_name -> core.finding.FindingSetting
	54, // 19: core.finding.GetFindingSettingRequest.status:type_name -> core.finding.FindingSettingStatus
	55, // 20: core.finding.GetFindingSettingResponse.finding_setting:type_name -> core.finding.FindingSetting
	56, // 21: core.finding.PutFindingSettingRequest.finding_setting:type_name -> core.finding.FindingSettingForUpsert
	55, // 22: core.finding.PutFindingSettingResponse.finding_setting:type_name -> core.finding.FindingSetting
	...
	16, // 32: core.finding.FindingService.ClearScore:input_type -> core.finding.ClearScoreRequest
	17, // 33: core.finding.FindingService.ListResource:input_type -> core.finding.ListResourceRequest
	19, // 34: core.finding.FindingService.GetResource:input_type -> core.finding.GetResourceRequest
	21, // 35: core.finding.FindingService.PutResource:input_type -> core.finding.PutResourceRequest
	23, // 36: core.finding.FindingService.DeleteResource:input_type -> core.finding.DeleteResourceRequest
	24, // 37: core.finding.FindingService.ListResourceTag:input_type -> core.finding.ListResourceTagRequest
	26, // 38: core.finding.FindingService.ListResourceTagName:input_type -> core.finding.ListResourceTagNameRequest
	28, // 39: core.finding.FindingService.TagResource:input_type -> core.finding.TagResourceRequest
	30, // 40: core.finding.FindingService.UntagResource:input_type -> core.finding.UntagResourceRequest
	31, // 41: core.finding.FindingService.GetPendFinding:input_type -> core.finding.GetPendFindingRequest
	33, // 42: core.finding.FindingService.PutPendFinding:input_type -> core.finding.PutPendFindingRequest
	35, // 43: core.finding.FindingService.DeletePendFinding:input_type -> core.finding.DeletePendFindingRequest
	36, // 44: core.finding.FindingService.ListFindingSetting:input_type -> core.finding.ListFindingSettingRequest
	38, // 45: core.finding.FindingService.GetFindingSetting:input_type -> core.finding.GetFindingSettingRequest
	40, // 46: core.finding.FindingService.PutFindingSetting:input_type -> core.finding.PutFindingSettingRequest
	42, // 47: core.finding.FindingService.DeleteFindingSetting:input_type -> core.finding.DeleteFindingSettingRequest
	1,  // 48: core.finding.FindingService.ListFinding:output_type -> core.finding.ListFindingResponse
	3,  // 49: core.finding.FindingService.BatchListFinding:output_type -> core.finding.BatchListFindingResponse
	5,  // 50: core.finding.FindingService.GetFinding:output_type -> core.finding.GetFindingResponse
	7,  // 51: core.finding.FindingService.PutFinding:output_type -> core.finding.PutFindingResponse
	57, // 52: core.finding.FindingService.DeleteFinding:output_type -> google.protobuf.Empty
	10, // 53: core.finding.FindingService.ListFindingTag:output_type -> core.finding.ListFindingTagResponse
	12, // 54: core.finding.FindingService.ListFindingTagName:output_type -> core.finding.ListFindingTagNameResponse
	14, // 55: core.finding.FindingService.TagFinding:output_type -> core.finding.TagFindingResponse
	57, // 56: core.finding.FindingService.UntagFinding:output_type -> google.protobuf.Empty
	57, // 57: core.finding.FindingService.ClearScore:output_type -> google.protobuf.Empty
	18, // 58: core.finding.FindingService.ListResource:output_type -> core.finding.ListResourceResponse
	20, // 59: core.finding.FindingService.GetResource:output_type -> core.finding.GetResourceResponse
	22, // 60: core.finding.FindingService.PutResource:output_type -> core.finding.PutResourceResponse
	57, // 61: core.finding.FindingService.DeleteResource:output_type -> google.protobuf.Empty
	25, // 62: core.finding.FindingService.ListResourceTag:output_type -> core.finding.ListResourceTagResponse
	27, // 63: core.finding.FindingService.ListResourceTagName:output_type -> core.finding.ListResourceTagNameResponse
	29, // 64: core.finding.FindingService.TagResource:output_type -> core.finding.TagResourceResponse
	57, // 65: core.finding.FindingService.UntagResource:output_type -> google.protobuf.Empty
	32, // 66: core.finding.FindingService.GetPendFinding:output_type -> core.finding.GetPendFindingResponse
	34, // 67: core.finding.FindingService.PutPendFinding:output_type -> core.finding.PutPendFindingResponse
	57, // 68: core.finding.FindingService.DeletePendFinding:output_type -> google.protobuf.Empty
	37, // 69: core.finding.FindingService.ListFindingSetting:output_type -> core.finding.ListFindingSettingResponse
	39, // 70: core.finding.FindingService.GetFindingSetting:output_type -> core.finding.GetFindingSettingResponse
	41, // 71: core.finding.FindingService.PutFindingSetting:output_type -> core.finding.PutFindingSettingResponse
	57, // 72: core.finding.FindingService.DeleteFindingSetting:output_type -> google.protobuf.Empty
