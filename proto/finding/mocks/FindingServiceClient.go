...
// NewFindingServiceClient creates a new instance of FindingServiceClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewFindingServiceClient(t testing.TB) *FindingServiceClient {
