...
// GetAlertAISummary provides a mock function with given fields: ctx, in, opts
func (_m *FindingServiceClient) GetAlertAISummary(ctx context.Context, in *finding.GetAlertAISummaryRequest, opts ...grpc.CallOption) (*finding.GetAlertAISummaryResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *finding.GetAlertAISummaryRequest, ...grpc.CallOption) (*finding.GetAlertAISummaryResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *finding.GetAlertAISummaryRequest, ...grpc.CallOption) *finding.GetAlertAISummaryResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *finding.GetAlertAISummaryRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// ListFindingForOrg provides a mock function with given fields: ctx, in, opts
func (_m *FindingServiceClient) ListFindingForOrg(ctx context.Context, in *finding.ListFindingForOrgRequest, opts ...grpc.CallOption) (*finding.ListFindingForOrgResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *finding.ListFindingForOrgRequest, ...grpc.CallOption) (*finding.ListFindingForOrgResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *finding.ListFindingForOrgRequest, ...grpc.CallOption) *finding.ListFindingForOrgResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *finding.ListFindingForOrgRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// UpdateFindingAISummary provides a mock function with given fields: ctx, in, opts
func (_m *FindingServiceClient) UpdateFindingAISummary(ctx context.Context, in *finding.UpdateFindingAISummaryRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *emptypb.Empty
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *finding.UpdateFindingAISummaryRequest, ...grpc.CallOption) (*emptypb.Empty, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *finding.UpdateFindingAISummaryRequest, ...grpc.CallOption) *emptypb.Empty); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*emptypb.Empty)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *finding.UpdateFindingAISummaryRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
