...
type mockConstructorTestingTNewFindingServiceServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewFindingServiceServer(t mockConstructorTestingTNewFindingServiceServer) *FindingServiceServer {
