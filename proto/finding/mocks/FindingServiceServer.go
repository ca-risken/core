...
// NewFindingServiceServer creates a new instance of FindingServiceServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewFindingServiceServer(t testing.TB) *FindingServiceServer {
