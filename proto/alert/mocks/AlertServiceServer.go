...
type mockConstructorTestingTNewAlertServiceServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewAlertServiceServer(t mockConstructorTestingTNewAlertServiceServer) *AlertServiceServer {
