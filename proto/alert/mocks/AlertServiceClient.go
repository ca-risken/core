...
type mockConstructorTestingTNewAlertServiceClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewAlertServiceClient(t mockConstructorTestingTNewAlertServiceClient) *AlertServiceClient {
